...
## Notebooks
- [hds_shapes_1_etl](notebooks/hds_shapes_1_etl.ipynb) notebook to read the images and prepare data (ETL).
- [hds_shapes_2_classify](notebooks/hds_shapes_2_classify.ipynb) notebook to do Shape classification. 
